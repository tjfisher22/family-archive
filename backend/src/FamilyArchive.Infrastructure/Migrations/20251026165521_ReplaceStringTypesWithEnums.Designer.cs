...
namespace FamilyArchive.Infrastructure.Migrations
{
    ...
    [Migration("20251026165521_ReplaceStringTypesWithEnums")]
    partial class ReplaceStringTypesWithEnums
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FamilyArchive.Domain.Entities.Clan", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("FamilyArchive.Domain.Entities.MemberName", b =>
                {
                    ...
                    b.Property<string>("OtherNameType")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("FamilyArchive.Domain.Entities.Member", b =>
                {
                    b.HasOne("FamilyArchive.Domain.Entities.Clan", "Clan")
                        .WithMany("Members")
